...
# =====================================================================
# NAVIGATION & UI (FIXED MENU LAYOUTS AS REQUESTED)
# =====================================================================
async def show_main_menu(update: Update, msg_text: str):
    # Requirement 1 & 5: Find Job completely removed. Tasks renamed to 📋 Tasks.
    keyboard = [
        ["💳 Wallet", "👤 Profile"],
        ["👥 Referral", "🎁 Bonus"],
        ["📞 Support", "📋 Tasks"]
...
async def show_tasks_menu(update: Update, msg_text: str):
    # Requirement 3: Submenu containing ONLY Find Job, Create Job, Posted Tasks, Submitted Tasks, and Back arrow.
    keyboard = [
        ["🔍 Find Job", "➕ Create Job"],
...
async def buttons(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Requirement 6: Left arrow back button returns directly to main menu
    ...
    # Requirement 2 & 4: Dedicated 📋 Tasks menu switch triggers isolated submenu safely
    if text == "📋 Tasks":
        safe_clear_state(context)
