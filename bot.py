...
def get_force_join_keyboard():
    ...
    if channel_val.startswith("@"):
        ...
        # Fallback for numerical Chat IDs, requiring manual link
...
async def complete_user_registration(update: Update, context: ContextTypes.DEFAULT_TYPE, user_id: int, referrer_id: int = 0):
    ...
    if is_new_user and referrer_id != 0:
        notification_text = (
            ...
            f"💰 রেফার বোনাস: {ref_reward} টাকা\n"
            "⏳ বর্তমান অবস্থা: Pending\n\n"
            "রেফার করা সদস্যকে কাজ সম্পন্ন করে প্রথম সফল Withdrawal করতে হবে।\n\n"
            f"Withdrawal সম্পন্ন হলে আপনার Pending Bonus স্বয়ংক্রিয়ভাবে Successful হয়ে যাবে এবং {ref_reward} টাকা আপনার ব্যালেন্সে যোগ হবে।\n\n"
